...
public class RecipeStepListActivity extends BaseActivity implements IMVPRecipeStepListView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if (savedInstanceState != null && savedInstanceState.containsKey(MainActivity.RECIPE))
    ...
    class StepsAdapter extends RecyclerView.Adapter<StepsAdapter.ViewHolder> {
        ...
        public int getItemCount() {
            ...
            int listCount = (steps == null) ? 0 : steps.size() + ((isIngredient) ? 1 : 0);
        ...
        public class ViewHolderIngredients extends ViewHolder {
